...
import com.visulon.pom.Product;
import com.visulon.pom.VisulonLoginPage;
import com.visulon.pom.AssortmentMenu.AssortmentMenuleftpanel;

public class Productopt extends BaseTest
{
	@Test
	public void testProductopt() throws InterruptedException
	{
		...
		Product rv6 = new Product(driver);
		rv6.clickonwhiteboard();
		Thread.sleep(3000);
		rv6.clickonSKU();
		Thread.sleep(3000);
		rv6.ContextMenu();
