...
public class TestAssortment_Attribute_EditBuyGrid extends BaseTest
{

	@Test
	public void testAssortment_Attribute_EditBuyGrid() throws InterruptedException
	{
	...
	Assortment_Attribute_EditBuyGrid rv6 = new Assortment_Attribute_EditBuyGrid(driver);
	rv6.EditBuyGrid();
    Thread.sleep(3000);
    rv6.EditBuyGrid_BuyInfo_CA();
   // rv55.EditBuyGrid_BuyInfo_US();
    Thread.sleep(3000);
    rv6.EditBuyGrid_Status();
    Thread.sleep(3000);
    rv6.EditBuyGrid_Units();
    Thread.sleep(3000);
    rv6.EditBuyGrid_ApplyButton();
    Thread.sleep(3000);
    rv6.QtyBuyTable();
    Thread.sleep(3000);
