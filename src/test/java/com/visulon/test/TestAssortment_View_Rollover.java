...
public class TestAssortment_View_Rollover extends BaseTest
{
	@Test
	public void testAssortment_View_Rollover() throws InterruptedException, SikuliException
	{
		...
		Assortment_ViewMenu rv6=new Assortment_ViewMenu(driver);
	     ...
	     Thread.sleep(5000);	
		//click on Rollover
	     Assortment_View_Rollover rv7 =new Assortment_View_Rollover(driver);
	     rv7.RolloverZoom();
	     //move on image
	     
	    rv7.rollover_Image("../Tommy/SikuliImages/rollover.PNG");
