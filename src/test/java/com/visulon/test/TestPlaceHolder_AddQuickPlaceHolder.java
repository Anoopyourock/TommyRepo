...
public class TestPlaceHolder_AddQuickPlaceHolder extends BaseTest

{
	@Test
	public void testPlaceHolder_AddQuickPlaceHolder() throws InterruptedException
	{
		...
		PlaceHolder_AddQuick_PlaceHolder rv7 = new PlaceHolder_AddQuick_PlaceHolder(driver);
		//Click on quickplaceholder
		rv7.clickonQuickPlaceholder();
