...
import com.visulon.pom.Attributes.Assortment_Attribute_HideProductName;

public class Test_Attribute_AttributeMenu_HideProductName extends BaseTest
{
	@Test
	public void test_Attribute_AttributeMenu_HideProductName() throws InterruptedException
	{
		...
		//click on hide product name
		
		Assortment_Attribute_HideProductName rv6= new Assortment_Attribute_HideProductName(driver);
		rv6.hide_product_name();
