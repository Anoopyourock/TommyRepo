...
public class TestData_Actions_Product_Analytics extends BaseTest
{
	@Test
	public void testData_Actions_Product_Statistics() throws SikuliException, InterruptedException
	{
	...
	Data_Actions_ProductAnalytics rv13= new Data_Actions_ProductAnalytics(driver);
	rv13.ClickonProductAnalytics();
	...
	Thread.sleep(5000);
	rv13.ClickonBarchart1Link();
	//click on PieChart Link
	Thread.sleep(5000);
	rv13.ClickonPiechart1Link();
	Thread.sleep(5000);
	rv9.ClickonCancel("../Tommy/SikuliImages/ClickonCancelicon.PNG");
