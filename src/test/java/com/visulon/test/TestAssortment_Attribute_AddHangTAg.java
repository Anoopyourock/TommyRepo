...
public class TestAssortment_Attribute_AddHangTAg extends BaseTest
{
	@Test
	public void testAssortment_Attribute_AddHangTAg() throws InterruptedException
	{
		...
		//click on hang tag
		Assortment_Attribute_AddHangTag rv6= new Assortment_Attribute_AddHangTag(driver);
		
		rv6.Add_Hang_Tag();
	     Thread.sleep(3000);
	     rv6.Add_Hang_Tag_AllProducts();
	     Thread.sleep(3000);
	     rv6.Add_Hang_Tag_PrimeLOft();
	     Thread.sleep(3000);
	     rv6.Add_Hang_Tag_sustainable();
	     Thread.sleep(3000);
	     rv6.Add_Hang_Tag_save();
