...
public class TestAssortment_Attribute_ManageAttribute extends BaseTest
{
	@Test
	public void testAssortment_Attribute_ManageAttribute() throws InterruptedException
	{
		...
		Thread.sleep(5000);
		Assortment_Attribute_ManageAttributes rv6= new Assortment_Attribute_ManageAttributes(driver);
    Thread.sleep(3000);
    rv6.manageAttribute();
    Thread.sleep(3000);
    rv6.select_Attributes(1);
    Thread.sleep(3000);
    rv6.add_Attribute();
    Thread.sleep(3000);
    rv6.apply_Changes();
