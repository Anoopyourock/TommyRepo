...
public class TestAssortment_Attribute_AttributeView extends BaseTest
{
	@Test
	public void testAssortment_Attribute_AttributeView() throws InterruptedException
	{
	...
	rv5.Attribute();
	//click on Attribute view
	
	Assortment_Attribute_AttributeView rv6= new Assortment_Attribute_AttributeView(driver);
	
	rv6.AttributeViews();
    rv6.AttributeViews_Template();
    Thread.sleep(3000);
    rv6.AttributeViews_applyChanges();
    Thread.sleep(3000);
    rv6.ApplyChanges_Assortment();
