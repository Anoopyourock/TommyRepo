...
public class TestAssortment_View_SliderPreview extends BaseTest
{
	@Test
	public void testAssortment_View_SliderPreview() throws InterruptedException, SikuliException
	{
		...
		Assortment_ViewMenu rv5=new Assortment_ViewMenu(driver);
	     ...
	     Assortment_View_SliderPreview rv6= new Assortment_View_SliderPreview(driver);
	     
		    rv6.SliderPreview();
		    Thread.sleep(3000);
		    rv6.SliderPreview_PresentationView();
		    Thread.sleep(3000);
		    rv6.SliderPreview_Back_button();
